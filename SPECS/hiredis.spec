...
%build
make PREFIX="%{_prefix}" LIBRARY_PATH="%{_lib}" DEBUG="%{optflags}" LDFLAGS="%{?__global_ldflags}"
...
cd %{buildroot}%{_libdir} && ln -sf libhiredis.so.0.14 libhiredis.so.0
...
%changelog
* Sat May 16 2020 Xiaok<luxiaok2008@gmail.com> - 0.14.1-1
- Built for 0.14.1
