...
%changelog
* Wed Jan 16 2019 Jiri Denemark <jdenemar@redhat.com> - 5.0.0-1
- Rebased to libvirt-python-5.0.0

* Wed Dec  5 2018 Jiri Denemark <jdenemar@redhat.com> - 4.10.0-1
- Rebased to libvirt-python-4.10.0

* Tue Nov 20 2018 Jiri Denemark <jdenemar@redhat.com> - 4.9.0-1
- Rebased to libvirt-python-4.9.0

* Tue Nov 20 2018 Jiri Denemark <jdenemar@redhat.com> - 4.8.0-1
- Rebased to libvirt-python-4.8.0

* Tue Nov 20 2018 Jiri Denemark <jdenemar@redhat.com> - 4.7.0-1
- Rebased to libvirt-python-4.7.0

* Mon Nov 19 2018 Jiri Denemark <jdenemar@redhat.com> - 4.6.0-1
- Rebased to libvirt-python-4.6.0

* Tue Nov 13 2018 Jiri Denemark <jdenemar@redhat.com> - 4.5.0-1
- Rebased to libvirt-python-4.5.0

* Tue Nov 13 2018 Jiri Denemark <jdenemar@redhat.com> - 4.4.0-1
- Rebased to libvirt-python-4.4.0

* Thu May  3 2018 Jiri Denemark <jdenemar@redhat.com> - 4.3.0-1
- Rebased to libvirt-python-4.3.0

* Mon Apr  9 2018 Jiri Denemark <jdenemar@redhat.com> - 4.2.0-1
- Rebased to libvirt-python-4.2.0

* Tue Mar 20 2018 Jiri Denemark <jdenemar@redhat.com> - 4.1.0-1
- Rebased to libvirt-python-4.1.0
...
* Wed May  3 2017 Jiri Denemark <jdenemar@redhat.com> - 3.2.0-2
- Rebuild libvirt-python (rhbz#1382642)

* Mon Apr  3 2017 Jiri Denemark <jdenemar@redhat.com> - 3.2.0-1
- Rebased to libvirt-python-3.2.0 (rhbz#1382642)

* Fri Mar  3 2017 Jiri Denemark <jdenemar@redhat.com> - 3.1.0-1
- Rebased to libvirt-python-3.1.0 (rhbz#1382642)

* Tue Feb  7 2017 Jiri Denemark <jdenemar@redhat.com> - 3.0.0-1
- Rebased to libvirt-python-3.0.0 (rhbz#1382642)

* Tue Dec  6 2016 Jiri Denemark <jdenemar@redhat.com> - 2.5.0-1
- Rebased to libvirt-python-2.5.0 (rhbz#1382642)
- The rebase also fixes the following bugs:
    rhbz#1377071

* Mon Aug  1 2016 Jiri Denemark <jdenemar@redhat.com> - 2.0.0-2
- Fix crash in storage pool refresh callback (rhbz#1354271)
